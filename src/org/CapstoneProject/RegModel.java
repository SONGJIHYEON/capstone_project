...
//		vRegModel2 = new JLabel("모델등록");
		...
		xModelNm.setPreferredSize(new Dimension(120, 28));
		xModelCode = new JTextField(20);
		xModelCode.setPreferredSize(new Dimension(120, 28));
		xModelCtgr1 = new JTextField(20);
		xModelCtgr1.setPreferredSize(new Dimension(120, 28));
		xModelCtgr2 = new JTextField(20);
		xModelCtgr2.setPreferredSize(new Dimension(120, 28));
		xModelExp = new JTextField(20);
		xModelExp.setPreferredSize(new Dimension(120, 28));
		xModelNick = new JTextField(20);
		xModelNick.setPreferredSize(new Dimension(120, 28));
//		xModelSize = new JTextField(20);

		vModelCode = new JLabel("모델코드");
		vModelCode.setFont(new Font("휴먼매직체", Font.PLAIN, 20));
		
		vModelCtgr1 = new JLabel("1차분류");
		vModelCtgr1.setFont(new Font("휴먼매직체", Font.PLAIN, 20));
		...
		vModelCtgr2.setFont(new Font("휴먼매직체", Font.PLAIN, 20));
		vModelExp = new JLabel("모델상세사이즈");
		vModelExp.setFont(new Font("휴먼매직체", Font.PLAIN, 20));
		vModelNick = new JLabel("모델별칭");
		vModelNick.setFont(new Font("휴먼매직체", Font.PLAIN, 20));
