...
public class Center_user extends JPanel implements ActionListener, MouseListener {
	
	static JPanel C_U = new JPanel();
	static JPanel N_U = new JPanel();
	static JPanel Q_U = new JPanel();
	...
	private JButton  bN_More, bQ_More, bR_More;
...
//		gridbagAdd(MenuBar, 0, 0, 7, 1);
		...
		gridbagAdd(vReview, 4, 0, 1, 1);
		
	    gridbagAdd(Scroll1, 0, 1, 1, 1);
	    
		gridbagconstraints.anchor = GridBagConstraints.CENTER;
		gridbagAdd(vSpace, 1, 0, 1, 1);
	    gridbagAdd(Scroll2, 2, 1, 1, 1);
		gridbagAdd(vSpace2, 3, 0, 1, 1);
	    

		gridbagconstraints.anchor = GridBagConstraints.EAST;
		gridbagAdd(bN_More, 0, 0, 1, 1);
		gridbagAdd(bQ_More, 2, 0, 1, 1);
		gridbagAdd(bR_More, 4, 0, 1, 1);
		
	    gridbagAdd(Scroll3, 4, 1, 1, 1);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == bN_More) {
			 switch (home_user.click) {
	            case "H":	home_user.C_U.removeAll();
	            			N_U = new Notice_user();
			        		...
			        		revalidate();
			        		break;
	            case "N":	Notice_user.C_U.removeAll();
			    			N_U = new Notice_user();
			    			N_U.setBounds(0, 100, d.width, d.height - 100);
							add(N_U);
							repaint();
