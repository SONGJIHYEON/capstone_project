...
public class home_admin extends JFrame implements MouseListener , ActionListener{
	...
	static JPanel C_A = new Center_admin();
...
//	    try {
//	    	img1 = ImageIO.read(new File("C:\\Users\\kimkibum\\Desktop\\메인 배경.png"));
//		    } catch (IOException e) {
//		   	 JOptionPane.showMessageDialog(null, "이미지 불러오기 실패");
//		   	 System.exit(0);
//		    }
//	    try {
//		   	img2 = ImageIO.read(new File("C:\\Users\\kimkibum\\Desktop\\메인 배경2.png"));
//		    } catch (IOException e) {
//		   	 JOptionPane.showMessageDialog(null, "이미지 불러오기 실패");
//		   	 System.exit(0);
//		    }
//	    BackgroundPanel sub = new BackgroundPanel();
//        sub.setSize(d.width, d.height);
//        win.add(sub);
//        
//        MainIcon Icon = new MainIcon();
//        Icon.setSize(d.width / 3, 100);
//        win.add(Icon);
...
//	    	  g.drawImage(img1, 0, 100, d.width, d.height, null);
//	    	  setOpaque(true);
//	      }
//	  }
//	  
//	  class MainIcon extends JPanel{
//		      public void paint(Graphics g) {
//		    	  g.drawImage(img2, 0, 0, d.width / 3, 100, null);
//		    	  setOpaque(true);
//		      }
//	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getSource() == Mn_Center) {
			...
			win.add(MenuBar1);
			win.add(MenuBar2);
        	C_A.setBounds(0, 100, d.width, d.height);
        	win.add(C_A);
        	repaint();
        	revalidate();
