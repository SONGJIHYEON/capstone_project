...
public class home_admin extends JFrame {
	private JLabel vHomeIcon, vViewIcon, vTop, vBottom, vOuter, vShirts, vShoes;
...
//		vHomeIcon.setPreferredSize(new Dimension(100,28));
		vManage = new JButton("쇼핑몰관리");
		vManage.setPreferredSize(new Dimension(200,28));
