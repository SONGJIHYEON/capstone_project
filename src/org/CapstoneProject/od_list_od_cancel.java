...
public class od_list_od_cancel extends JPanel implements ActionListener, MouseListener  {

   private JLabel od_cancel;      
         
   private JTextField  Tsearch;      
         
   private String[] col1 = {"No", "주문번호", "주문자명", "주문일시", "취소완료"};  
   private String[] search = {"주문번호", "주문자명"};      
   ...
   public od_list_od_cancel() {      
         
         gridbaglayout = new GridBagLayout();
         gridbagconstraints = new GridBagConstraints();
         
         od_cancel = new JLabel("주문관리(주문취소)");
         od_cancel.setPreferredSize(new Dimension(200,28));
