...
public class od_list_change extends JPanel implements ActionListener, MouseListener  {

   private JLabel od_change;      
         
   private JTextField  Tsearch;      
         
   private String[] col1 = {"No", "주문번호", "상품번호", "수량","사유"};  
   ...
   private JButton Bsearch,Breset;      
   ...
   public od_list_change() {      
         ...
         od_change = new JLabel("주문관리(교환신청)");
