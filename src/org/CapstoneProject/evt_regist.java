...
//			
//			int result = JOptionPane.showConfirmDialog(null, "해당 이벤트를 등록하시겠습니까?", "이벤트 등록 확인", JOptionPane.YES_NO_OPTION,
...
//						evtData.createevt();
//						JOptionPane.showMessageDialog(null, "이벤트가 등록되었습니다.", "이벤트 등록",
