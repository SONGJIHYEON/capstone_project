...
public class emp_re extends Dialog implements ActionListener, MouseListener {
   ...
   public emp_re(JFrame fr) {
      ...
      Lemp_no.setPreferredSize(new Dimension(120, 40));
      Lemp_no.setHorizontalAlignment(JLabel.CENTER);
      Lemp_no.setFont(new Font("돋음", Font.BOLD, 15));
      
      Lemp_nm = new JLabel("사원명");
      Lemp_nm.setPreferredSize(new Dimension(120, 40));
      Lemp_nm.setHorizontalAlignment(JLabel.CENTER);
      Lemp_nm.setFont(new Font("돋음", Font.BOLD, 15));
      Lemp_dt = new JLabel("입사일자");
      Lemp_dt.setPreferredSize(new Dimension(120, 40));
      Lemp_dt.setHorizontalAlignment(JLabel.CENTER);
      Lemp_dt.setFont(new Font("돋음", Font.BOLD, 15));
      Lemp_ph_num = new JLabel("휴대폰 번호");
      Lemp_ph_num.setPreferredSize(new Dimension(120, 40));
      Lemp_ph_num.setHorizontalAlignment(JLabel.CENTER);
      Lemp_ph_num.setFont(new Font("돋음", Font.BOLD, 15));
      Lemp_tp = new JLabel("사원구분");
      Lemp_tp.setPreferredSize(new Dimension(120, 40));
      Lemp_tp.setHorizontalAlignment(JLabel.CENTER);
      Lemp_tp.setFont(new Font("돋음", Font.BOLD, 15));
      
      Lemp_addr = new JLabel("주소");
      Lemp_addr.setPreferredSize(new Dimension(120, 30));
      Lemp_addr.setHorizontalAlignment(JLabel.CENTER);
      Lemp_addr.setFont(new Font("돋음", Font.BOLD, 15));
      
      
      Lemp_addr1 = new JLabel("기본주소");
      Lemp_addr1.setPreferredSize(new Dimension(120, 30));
      Lemp_addr1.setHorizontalAlignment(JLabel.CENTER);
      Lemp_addr1.setFont(new Font("돋음", Font.BOLD, 15));
      
      Lemp_addr2 = new JLabel("상세주소");
      Lemp_addr2.setPreferredSize(new Dimension(120, 30));
      Lemp_addr2.setFont(new Font("돋음", Font.BOLD, 15));
      Lemp_addr2.setHorizontalAlignment(JLabel.CENTER);
      
      Lreg_tp = new JLabel("정규직 구분");
      Lreg_tp.setPreferredSize(new Dimension(120, 40));
      Lreg_tp.setFont(new Font("돋음", Font.BOLD, 15));
      Lreg_tp.setHorizontalAlignment(JLabel.CENTER);
      
      Lreg_id = new JLabel("아이디");
      Lreg_id.setPreferredSize(new Dimension(120, 40));
      Lreg_id.setHorizontalAlignment(JLabel.CENTER);
      Lreg_id.setFont(new Font("돋음", Font.BOLD, 15));
      
      Lreg_pw = new JLabel("초기 비밀번호");
      Lreg_pw.setPreferredSize(new Dimension(120, 40));
      Lreg_pw.setHorizontalAlignment(JLabel.CENTER);
      Lreg_pw.setFont(new Font("돋음", Font.BOLD, 15));
      ...
      Bemp_num = new JButton("번호생성");
      Bemp_num.setPreferredSize(new Dimension(120, 28));
      Bemp_num.addActionListener(this);
      Bemp_num.setFocusPainted(false);
      Bemp_num.setBackground(Color.white);
      Bemp_num.setFont(new Font("돋음", Font.BOLD, 14));
      ...
      Bregist.setFont(new Font("돋음", Font.BOLD, 15));
      ...
      Bcancel.setFont(new Font("돋음", Font.BOLD, 15));
